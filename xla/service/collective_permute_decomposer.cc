...
absl::StatusOr<DecomposedCp> DecomposeCollectivePermute(
  ...
  after_all->SetAndSanitizeName(absl::StrCat(cp_name, "-after-all"));
  HloInstruction* recv = computation->AddInstruction(HloInstruction::CreateRecv(
      shape, after_all, channel_id, /*is_host_transfer=*/false));
  ...
  recv->SetAndSanitizeName(absl::StrCat(cp_name, "-recv"));
  send->SetAndSanitizeName(absl::StrCat(cp_name, "-send"));
  recv_done->SetAndSanitizeName(absl::StrCat(cp_name, "-recv-done"));
  send_done->SetAndSanitizeName(absl::StrCat(cp_name, "-send-done"));
  recv_data->SetAndSanitizeName(absl::StrCat(cp_name, "-recv-data"));
